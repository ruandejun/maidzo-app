...
class DepositItem extends React.Component {
    ...
    render() {
        ...
        const { id, transaction_holder, type, amount, detail, status, modified, created } = this.props
        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity onPress={this.onDetail.bind(this)} style={styles.headerContainer}>
                    ...
                    <Text style={styles.dateText}>{modified}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(DepositItem);