...
import RefundItem from './component/RefundItem'
import { getBottomSpace } from 'react-native-iphone-x-helper';

const LIMIT = 20

class RefundListView extends React.Component {
    ...
    onRefresh(){
        ...
        this.setState({isFetching: true, loadingMore: false, canLoadMore: true}, () => {
            fetchApi('get', `page/get_data_refund_by_username/${this.props.user.username}/data.json/`, {order: 'asc', offset: 0, limit: LIMIT})
            .then((data) => {
                // console.log(data)
    ...
    onEndReached(){
        ...
        this.setState({loadingMore: true}, () => {
            fetchApi('get', `page/get_data_refund_by_username/${this.props.user.username}/data.json/`, {order: 'asc', offset: this.state.items.length, limit: LIMIT})
            .then((data) => {
                // console.log(data)
                if(data){
