            ...
            <View style={styles.container}>
                ...
                <View style={{width: '100%', flex: 1, alignItems: 'center'}}>
                    ...
                    <Text style={{width: '90%', fontSize: 15, color: '#333333', fontFamily: Global.FontName, marginTop : 20}}>{'Website: '}
                        <Text style={{color: 'blue', textDecorationLine: 'underline'}} onPress={this.onOpenLink.bind(this, 'https://shipway247.com/')}>https://shipway247.com/</Text>
                    </Text>
                    ...
                    <Text style={{width: '90%', fontSize: 15, color: '#333333', fontFamily: Global.FontName}}>{'Địa chỉ: '}
                        <Text style={{color: Global.MainColor, textDecorationLine: 'underline'}} onPress={this.onOpenLink.bind(this, 'https://goo.gl/maps/9n9Vb3oH5gMS17VN6')}>Lô 5B Trung Yên 6, Yên Hoà, Cầu Giấy, Hà Nội</Text>
                    </Text>
                    <View style={{width: '90%', backgroundColor: '#CECECE', height: 1, marginTop : 15, marginBottom : 15}}/>
                    <Text style={{width: '90%', fontSize: 15, color: '#333333', fontFamily: Global.FontName}}>{'Hotline: '}
                        <Text style={{color: 'blue', textDecorationLine: 'underline'}} onPress={this.onOpenLink.bind(this, 'tel:+842439999247')}>842439999247</Text>
                    </Text>
                    <View style={{width: '90%', backgroundColor: '#CECECE', height: 1, marginTop : 15, marginBottom : 15}}/>
                </View>
            </View>
